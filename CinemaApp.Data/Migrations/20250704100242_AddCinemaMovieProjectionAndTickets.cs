...
{
    /// <inheritdoc />
    public partial class AddCinemaMovieProjectionAndTickets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableTickets = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "Count of available tickets"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "Shows if the movie projection in the cinema is active"),
